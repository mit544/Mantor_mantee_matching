...
export default function MenteeFormPage() {
  ...
  useEffect(() => {
    toast.success("Welcome, You are logged in as a Mentee!!", {
      position: "top-right",
      autoClose: 3000,
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      setMessage(res.ok ? "Mentee added successfully!" : " " + data.message);
    } catch {
            ...
            {currentStep === 1 && (
              <div className="space-y-4">
                <input
                  ...
                  className="w-full border p-3 rounded focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50"
                />
                <input
                  name="name"
                  placeholder="Name"
